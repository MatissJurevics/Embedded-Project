...
class Vehicle:
    ...
    def leader(self):
        ...
        self.mbox_lanes = NumbericMailbox("lanes", self.server)
        self.mbox_blue = NumbericMailbox("blue", self.server)
        self.mbox_yellow = NumbericMailbox("yellow", self.server)
        self.mbox_park = NumbericMailbox("park", self.server)
    ...
    def follower(self):
        ...
        self.mbox_lanes = NumbericMailbox("lanes", self.client)
        self.mbox_blue = NumbericMailbox("blue", self.client)
        self.mbox_yellow = NumbericMailbox("yellow", self.client)
        self.mbox_park = NumbericMailbox("park", self.client)
        SERVER = "ev3dev"
